    ...
    <div className="min-h-screen">
      ...
      <section className="relative h-[600px] flex items-center justify-center overflow-hidden">
        ...
        <div className="container mx-auto px-4 relative z-20 text-center">
          ...
          <h1 className="font-serif text-4xl md:text-6xl font-bold text-white mb-6 leading-tight max-w-4xl mx-auto">
            Welcome to<br />
      ...
      <section className="py-20 bg-white">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            <Card className="border-none shadow-2xl bg-gradient-to-br from-light-sage/50 to-white">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center mb-12">
            ...
            <p className="text-lg text-muted-foreground">
              ...
              Your journey to empowered motherhood starts here.
            </p>
          </div>
        </div>
      </section>
